...
import 'package:profile/src/dictionary/basic_profile_options.dart';
...
*/
  ...
  /// D: Replace with Dummy values, i.e. values that contain no PHI, but
  /// are consistent with VR.
  static Element replaceWithZero(Dataset ds, Tag tag, {bool required = false}) =>
...
*/
  ...
  static bool clean<V>(Dataset ds, Tag tag, List values, {bool required = false}) =>
  ...
  static Element removeUnlessDummy<V>(Dataset ds, Tag tag, List values,
      {bool required = false}) {
  ...
  static Element removeUidUnlessZeroOrDummy<V>(Dataset ds, Tag tag, List<V> values,
      {bool required = false}) {
  ...
  static const BasicProfile kReferencedSOPInstanceUIDinFile =
      const BasicProfile(PTag.kReferencedSOPInstanceUIDInFile, 'U', replaceUids);
  ...
  static const BasicProfile kCurveDate = const BasicProfile(PTag.kCurveDate, 'X', remove);
  ...
  static const BasicProfile kCurveTime = const BasicProfile(PTag.kCurveTime, 'X', remove);
  ...
  static const BasicProfile kInstitutionCodeSequence =
      const BasicProfile(PTag.kInstitutionCodeSequence, 'XZD', removeUnlessZeroOrDummy);
  ...
  static const BasicProfile kReferringPhysiciansIdentificationSequence =
      const BasicProfile(PTag.kReferringPhysicianIdentificationSequence, 'X', remove);
  static const BasicProfile kContextGroupExtensionCreatorUID =
      const BasicProfile(PTag.kContextGroupExtensionCreatorUID, 'U', replaceUids);
  ...
  static const BasicProfile kPhysician0xsofRecordIdentificationSequence =
      const BasicProfile(PTag.kPhysiciansOfRecordIdentificationSequence, 'X', remove);
  ...
  static const BasicProfile kPerformingPhysicianIdentificationSequence =
      const BasicProfile(PTag.kPerformingPhysicianIdentificationSequence, 'X', remove);
  ...
  static const BasicProfile kPhysician0xsReadingStudyIdentificationSequence =
      const BasicProfile(PTag.kPhysiciansReadingStudyIdentificationSequence, 'X', remove);
  ...
  static const BasicProfile kOperatorsIdentificationSequence =
      const BasicProfile(PTag.kOperatorIdentificationSequence, 'XD', removeUnlessDummy);
  ...
  static const BasicProfile kReferencedPerformedProcedureStepSequence =
      const BasicProfile(
          PTag.kReferencedPerformedProcedureStepSequence, 'XZD', removeUnlessZeroOrDummy);
  ...
  static const BasicProfile kSourceImageSequence =
      const BasicProfile(PTag.kSourceImageSequence, 'XZU', removeUidUnlessZeroOrDummy);
  ...
  static const BasicProfile kPatientsPrimaryLanguageModifierCodeSequence =
      const BasicProfile(PTag.kPatientPrimaryLanguageModifierCodeSequence, 'X', remove);
  ...
  static const BasicProfile kAllergies = const BasicProfile(PTag.kAllergies, 'X', remove);
  ...
  static const BasicProfile kDeviceSerialNumber =
      const BasicProfile(PTag.kDeviceSerialNumber, 'XZD', removeUnlessZeroOrDummy);
  static const BasicProfile kDeviceUID =
      const BasicProfile(PTag.kDeviceUID, 'U', replaceUids);
  static const BasicProfile kPlateID = const BasicProfile(PTag.kPlateID, 'X', remove);
  ...
  static const BasicProfile kGantryID = const BasicProfile(PTag.kGantryID, 'X', remove);
  static const BasicProfile kProtocolName =
      const BasicProfile(PTag.kProtocolName, 'XD', removeUnlessDummy);
  static const BasicProfile kAcquisitionDeviceProcessingDescription = const BasicProfile(
  ...
  static const BasicProfile kSynchronizationFrameOfReferenceUID =
      const BasicProfile(PTag.kSynchronizationFrameOfReferenceUID, 'U', replaceUids);
  ...
  static const BasicProfile kLargePaletteColorLookupTableUID =
      const BasicProfile(PTag.kLargePaletteColorLookupTableUID, 'U', replaceUids);
  ...
  static const BasicProfile kRequestedProcedureDescription =
      const BasicProfile(PTag.kRequestedProcedureDescription, 'XD', removeUnlessZero);
  ...
  static const BasicProfile kScheduledPatientInstitutionResidence =
      const BasicProfile(PTag.kScheduledPatientInstitutionResidence, 'X', remove);
  ...
  static const BasicProfile kScheduledPerformingPhysicianIdentificationSequence =
      const BasicProfile(
          PTag.kScheduledPerformingPhysicianIdentificationSequence, 'X', remove);
  ...
  static const BasicProfile kCommentsOnThePerformedProcedureStep =
      const BasicProfile(PTag.kCommentsOnThePerformedProcedureStep, 'X', remove);
  ...
  static const BasicProfile kPersonIdentificationCodeSequence =
      const BasicProfile(PTag.kPersonIdentificationCodeSequence, 'D', replaceWithDummy);
  ...
  static const BasicProfile kPlacerOrderNumberImagingServiceRequest = const BasicProfile(
      PTag.kPlacerOrderNumberImagingServiceRequest, 'Z', replaceWithZero);
  static const BasicProfile kFillerOrderNumberImagingServiceRequest = const BasicProfile(
  ...
  static const BasicProfile
      kReferencedGeneralPurposeScheduledProcedureStepTransactionUID = const BasicProfile(
  ...
  static const BasicProfile kVerifyingObserverSequence =
      const BasicProfile(PTag.kVerifyingObserverSequence, 'D', replaceWithDummy);
  ...
  static const BasicProfile kUID = const BasicProfile(PTag.kUID, 'U', replaceUids);
  ...
  static const BasicProfile kTemplateExtensionOrganizationUID =
      const BasicProfile(PTag.kTemplateExtensionOrganizationUID, 'U', replaceUids);
  ...
  static const BasicProfile kGraphicAnnotationSequence =
      const BasicProfile(PTag.kGraphicAnnotationSequence, 'D', replaceWithDummy);
  ...
  static const BasicProfile kContentCreatorIdentificationCodeSequence =
      const BasicProfile(PTag.kContentCreatorIdentificationCodeSequence, 'X', remove);
  ...
  static const BasicProfile kArbitrary = const BasicProfile(PTag.kArbitrary, 'X', remove);
