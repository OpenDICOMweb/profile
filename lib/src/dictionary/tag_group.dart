...
class TagGroup {
  ...
  static const TagGroup k50 =
      const TagGroup('Group18', 0X0050, isKeeper: false);
  static const TagGroup k60 =
      const TagGroup('Group18', 0X0060, isKeeper: false);
  static const TagGroup curves = k50;
  static const TagGroup overlays = k60;

  static const List<int> validGroups = const [
    0x0018,
    0x0020,
    0x0028,
    0x0050,
