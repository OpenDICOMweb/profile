...
class RetainUidsOption {
  ...
  static const kRequestedSOPInstanceUID = const RetainUidsOption(
      'RequestedSOPInstanceUID', 0x00001001, VR.kUI, 'K');
  static const kMediaStorageSOPInstanceUID = const RetainUidsOption(
      'MediaStorageSOPInstanceUID', 0x00020003, VR.kUI, 'K');
  static const kReferencedSOPInstanceUIDinFile = const RetainUidsOption(
  ...
  static const kFailedSOPInstanceUIDList = const RetainUidsOption(
      'FailedSOPInstanceUIDList', 0x00080058, VR.kUI, 'K');
  static const kContextGroupExtensionCreatorUID = const RetainUidsOption(
      'ContextGroupExtensionCreatorUID', 0x0008010d, VR.kUI, 'K');
  static const kReferencedStudySequence = const RetainUidsOption(
      'ReferencedStudySequence', 0x00081110, VR.kSQ, 'K');
  static const kReferencedPerformedProcedureStepSequence =
      const RetainUidsOption(
          'ReferencedPerformedProcedureStepSequence', 0x00081111, VR.kSQ, 'K');
  static const kReferencedPatientSequence = const RetainUidsOption(
      'ReferencedPatientSequence', 0x00081120, VR.kSQ, 'X');
  static const kReferencedImageSequence = const RetainUidsOption(
      'ReferencedImageSequence', 0x00081140, VR.kSQ, 'K');
  static const kReferencedSOPInstanceUID = const RetainUidsOption(
      'ReferencedSOPInstanceUID', 0x00081155, VR.kUI, 'K');
  ...
  static const kSynchronizationFrameofReferenceUID = const RetainUidsOption(
  ...
  static const kDimensionOrganizationUID = const RetainUidsOption(
      'DimensionOrganizationUID', 0x00209164, VR.kUI, 'K');
  static const kPaletteColorLookupTableUID = const RetainUidsOption(
      'PaletteColorLookupTableUID', 0x00281199, VR.kUI, 'K');
  static const kLargePaletteColorLookupTableUID = const RetainUidsOption(
  ...
  static const kReferencedGeneralPurposeScheduledProcedureStepTransactionUID =
      const RetainUidsOption(
          ...
          VR.kUI,
          'K');
  static const kTemplateExtensionOrganizationUID = const RetainUidsOption(
      'TemplateExtensionOrganizationUID', 0x0040db0c, VR.kUI, 'K');
  static const kTemplateExtensionCreatorUID = const RetainUidsOption(
      'TemplateExtensionCreatorUID', 0x0040db0d, VR.kUI, 'K');
  static const kFiducialUID =
      const RetainUidsOption('FiducialUID', 0x0070031a, VR.kUI, 'K');
  static const kStorageMediaFileSetUID = const RetainUidsOption(
      'StorageMediaFile_setUID', 0x00880140, VR.kUI, 'K');
  static const kReferencedFrameofReferenceUID = const RetainUidsOption(
      'ReferencedFrameofReferenceUID', 0x30060024, VR.kUI, 'K');
  static const kRelatedFrameofReferenceUID = const RetainUidsOption(
      'RelatedFrameofReferenceUID', 0x300600c2, VR.kUI, 'K');
  ...
  static const List<int> remove = const [0x00081120];
